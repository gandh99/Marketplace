...
## Screenshots
The homepage of Marketplace with a horizontal carousel displaying the trending items. 
<img src="https://github.com/gandh99/Marketplace/blob/master/screenshots/home_desktop.png" alt="alt text" width="100%" height="50%">

The homepage (and the entire website) was built to be mobile-first and responsive.
<img src="https://github.com/gandh99/Marketplace/blob/master/screenshots/home_mobile.png" alt="alt text" width="30%" height="30%">

When clicking on the account picture on the top right, the user is presented with the options to either login or register.
...
When the user browses for items under a particular category, they can buy the item by clicking on the 'Buy Item' button. They can also choose to sort the items displayed.
...
The items can also be searched based on an input value in the search bar.
<img src="https://github.com/gandh99/Marketplace/blob/master/screenshots/search_item.png" alt="alt text" width="100%" height="50%">

The confirmation modal box before a user can buy an item.
